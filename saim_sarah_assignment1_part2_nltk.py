# -*- coding: utf-8 -*-
"""SAIM_SARAH_Assignment1_Part2_NLTK.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1_r6-_EZiT2TBk2QT02CWqyd9yjaoArOX
...
def question_two():
    ...
    """
    tokens = nltk.word_tokenize(moby_raw)
    count = sum(1 for t in tokens if t.lower() == 'whale')
...
def question_four():
    ...
    result = [w for w, f in freq.items() if len(w) > 5 and f > 150]
...
def question_six():
    ...
    """
    tokens = [w for w in nltk.word_tokenize(moby_raw) if w.isalpha()]
    freq = nltk.FreqDist(tokens)

    result = [(f, w) for w, f in freq.items() if f > 2000]
...
def question_eight():
    ...
    tokens = [
        w.lower() for w in nltk.word_tokenize(moby_raw)
